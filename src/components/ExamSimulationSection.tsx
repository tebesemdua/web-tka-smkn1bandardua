...
export const ExamSimulationSection: React.FC<ExamSimulationSectionProps> = ({
  ...
  const handleFinishExam = () => {
    ...
    const result: ExamResult = {
      ...
      studentNisn: currentUser.nisn || '0067489211',
      studentEmail: currentUser.email,
      classId: currentUser.classId || 'XII-MIPA-1',
      major: currentUser.major || 'MIPA',
      score: finalScore,
          ...
          <div>
            <div className="flex items-center gap-2">
              ...
              <h3 className="text-lg font-bold text-slate-900">
                Pusat Simulasi Ujian CBT TKA 2026
              </h3>
            </div>
            <p className="text-xs text-slate-500 mt-1">
              Uji kesiapan akademik Anda dengan paket simulasi soal HOTS berstandar Dinas Pendidikan Aceh & UTBK-SNBT
            </p>
          </div>
