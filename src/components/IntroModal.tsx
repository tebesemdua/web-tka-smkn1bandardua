          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 mb-6 text-left">
            <div className="bg-white p-3.5 rounded-2xl border border-emerald-100 shadow-sm flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-[11px] text-slate-500">Google Classroom [embrt4ws] & Modul Kejuruan</p>
              </div>
            </div>
            ...
            <div className="bg-white p-3.5 rounded-2xl border border-emerald-100 shadow-sm flex items-start gap-3">
              ...
              <div>
                <h4 className="text-xs font-bold text-slate-800">Akun belajar.id</h4>
                <p className="text-[11px] text-slate-500">31 Guru Pengajar & Siswa (Default: belajar123)</p>
              </div>
            </div>
          </div>
