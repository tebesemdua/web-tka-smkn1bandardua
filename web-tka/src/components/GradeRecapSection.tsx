      ...
      <div className="bg-white rounded-3xl p-6 shadow-sm border border-slate-200/80">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 mt-6 pt-6 border-t border-slate-100">
          <div>
            ...
            >
              <option value="all">Semua 7 Kelas XII</option>
              <option value="XII TKJ 1">Kelas XII TKJ 1</option>
              <option value="XII TKJ 2">Kelas XII TKJ 2</option>
              <option value="XII TBSM 1">Kelas XII TBSM 1</option>
              <option value="XII TBSM 2">Kelas XII TBSM 2</option>
              <option value="XII TKR">Kelas XII TKR</option>
              <option value="XII TP">Kelas XII TP</option>
              <option value="XII DPB">Kelas XII DPB</option>
            </select>
          </div>
          ...
          <div>
            ...
            <select
              ...
              className="w-full p-2.5 bg-slate-50 border border-slate-200 rounded-xl text-xs font-semibold text-slate-800"
            >
              <option value="all">Semua Domain Uji TKA</option>
              <option value="Numerasi Terapan SMK">Numerasi Terapan SMK</option>
              <option value="Literasi Kejuruan SMK">Literasi Kejuruan SMK</option>
              <option value="Vocational English">Vocational English</option>
              <option value="Penalaran & Troubleshooting">Penalaran & Troubleshooting</option>
              <option value="Simulasi Akbar TKA SMK">Simulasi Akbar TKA SMK</option>
            </select>
          </div>
